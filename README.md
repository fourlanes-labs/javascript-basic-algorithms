...
Welcome to your first JavaScript lab at Four Lanes!
...
*At Four Lanes, we use Pull Requests (PR) to submit lab assignments and verify student's work. After completing all the mandatory iterations, you should commit your code and create a Pull Request. If you can't finish a part of an iteration or still haven't completed all the iterations or the bonuses, it's okay; you should still submit the Pull Request before the start of the class on the next day.*<br>
...
<details>
  ...
  console.log(str.toUpperCase());  // "FOURLANES"
  ```
  ...
  console.log(str.toLowerCase());  // "fourlanes"
  ```
